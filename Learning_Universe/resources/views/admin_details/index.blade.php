...
<div class="ml-72 p-12 flex-1">
        <!-- content here! -->
            ...
            <div class="flex justify-between">
                ...
                <a href="{{ route('detail-material.create', ['class_id' => $onlineClass, 'material_id' => $material_id]) }}">
            ...
            <br>
                ...
                <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50"
                    role="alert">
                    <span class="font-medium">What's wrong? </span>
                    {{Session::get('error')}}
                </div>
                @endif
                    ...
                    <table class="w-full text-sm text-left text-gray-500 top-0">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4">
                                    <img src="{{ asset('uploads/detailMaterials/' . $detail->detail_image) }}" alt="{{ $detail->detail_title }}" style="max-width: 100px; max-height: 100px;">
                                </td>
                                <td class="px-6 py-4">
                                    {{ $detail->detail_title }}
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('detail-material.edit', ['class_id' => $onlineClass, 'material_id' => $material_id, 'id' => $detail->id]) }}" class="font-medium text-red-600">
                                ...
                                <form onsubmit="return confirm('Are you sure wanna delete this data?')"
                                    action="{{ route('detail-material.destroy', ['class_id' => $onlineClass, 'material_id' => $material_id, 'id' => $detail->id]) }}" method="post">
