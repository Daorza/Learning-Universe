                    ...
                    <div class="relative overflow-x-auto sm:rounded-lg px-20">
                        ...
                        <form action="{{ url('add-class') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="class_title" id="class_title" required value="{{ Session::get
                                    ('class_title') }}"
                            ...
                            <br>
                            <div class="space-y-2">
                                <label for="class_description" class="font-medium">Description</label>
                                <input type="text" name="class_description" id="class_description"
                                    class="block w-full p-2 mt-2 shadow rounded-md text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner">
                            </div>
                            <br>
                            <div class="space-y-2">
                                <label for="class_price" class="font-medium">Price</label>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="file" name="class_picture" id="class_picture" required value="{{ Session::get
                                    ('class_picture') }}"
                                    class="block w-full p-2 mt-2 shadow rounded-md text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner">
                            </div>
                            <br>
