...
<title>Category Data | Edit</title>
        ...
        <div class="flex justify-start mx-auto ml-32">
            ...
            <div class="flex-1 p-2 shadow-md bg-white rounded-md mt-10 w-4/5 mx-auto">
                <div class="relative overflow-x-auto sm:rounded-lg px-20">
                    <!-- form -->
                    <h1 class="flex justify-center text-xl font-bold uppercase mt-8">Category Form</h1>
                    ...
                    <form action="{{ url('category/'.$categories->id) }}" method="post">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="category_name" id="category_name" required value="{{ $categories->category_name }}"
