...
<title>Material Data | Create</title>
                    ...
                    <div class="relative overflow-x-auto sm:rounded-lg px-20">
                        ...
                        @if ($errors->any())
                            <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
                                <strong>There were some errors with your submission. Please correct them.</strong>
                        ...
                        <form action="{{ route('materials.store') }}" method="post">
                            ...
                            <div class="space-y-2">
                                <label for="material_title" class="font-medium">Material Title</label>
                                <input type="text" name="material_title" id="material_title" required value="{{ old('material_title') }}"
                            ...
                            <br>
                            <div class="space-y-2">
                                <label for="material_description" class="font-medium">Material Description</label>
                                <input type="text" name="material_description" id="material_description" required value="{{ old('material_description') }}"
                                    class="block w-full p-2 mt-2 shadow rounded-md text-gray-900 bg-stone-50 appearance-none focus:outline-gray-800 focus:bg-gray-100 focus:shadow-inner">
                            </div>
                            <br>
