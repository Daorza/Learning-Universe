...
<title>Material Data | Edit</title>
<div class="ml-72 p-12 flex-1">
        ...
        <div class="flex justify-start mx-auto ml-32">
            <div class="flex ">
                ...
                <div class="ml-4 text-xl font-bold capitalize border-l-2 border-black border-solid border-spacing-4 px-4">Material table</div>
            ...
            <div class="flex-1 p-2 shadow-md bg-white rounded-md mt-10 w-4/5 mx-auto">
                <div class="relative overflow-x-auto sm:rounded-lg px-20">
                    ...
                    <form action="{{ route('materials.update', ['id' => $materials->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="space-y-2">
                        ...
                        <a href="{{ route('materials.index', ['class_id' => $onlineClass->id]) }}">
                            <button type="button" class="px-8 py-2 mt-2 font-medium tracking-wide text-white uppercase rounded-md shadow-md bg-gray-700 focus:outline-none hover:bg-gray-900 hover:text-lg">
                                Back
                            </button>
                        </a>
                          <button type="submit"
